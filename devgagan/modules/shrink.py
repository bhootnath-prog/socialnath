...
async def token_handler(client, message):
    ...
    if len(message.command) <= 1:
        image_url = "https://graph.org/file/2926c97bc87f1a0d00907-dfaf154dd2b83c70ab.jpg"
        join_button = InlineKeyboardButton("Join Channel", url="https://t.me/BillaSpace")
        premium = InlineKeyboardButton("Get Premium", url="https://t.me/x_ifeelram")   
