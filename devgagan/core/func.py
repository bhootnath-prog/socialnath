...
async def subscribe(app, message):
   ...
   if update_channel:
      try:
        ...
        await message.reply_photo(photo="https://graph.org/file/2926c97bc87f1a0d00907-dfaf154dd2b83c70ab.jpg",caption=caption, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Join Now...", url=f"{url}")]]))
        return 1
      except Exception:
         await message.reply_text("Something Went Wrong. Contact us @BillaCore...")
         return 1
